...
from arm64nsd.application.dto import (
...
from arm64nsd.domain.events import (
    ParsingJobCompleted,
    ParsingJobStarted,
    SourceUnitParsed,
    SourceUnitParsingFailed,
)
from arm64nsd.domain.model import ParseOutcome, ParseStatus, ParsingJob, SourceUnit
from arm64nsd.domain.ports import (
...
class ParsingJobService:
    ...
    def parse_directory(self, command: ParseDirectoryCommand) -> ParsingJobReportDTO:
        source_units = tuple(self.source_repository.list_asm_sources(command.root_path))
