...
from arm64nsd.domain.control_flow import ControlFlowDiagram
from arm64nsd.domain.events import DomainEvent
from arm64nsd.domain.model import ParserVersion, ParseOutcome, ParsingJob, SourceUnit
...
class SourceRepository(ABC):
    ...
    @abstractmethod
    def list_asm_sources(self, root_path: str) -> Sequence[SourceUnit]:
        raise NotImplementedError
...
class AssemblySyntaxParser(ABC):
    @property
    @abstractmethod
...
class Arm64ControlFlowExtractor(ABC):
    @abstractmethod
