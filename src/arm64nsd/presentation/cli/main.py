...
from arm64nsd.application.control_flow import (
...
from arm64nsd.infrastructure.system import (
...
def _build_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Parse ARM64 assembly source files.")
    parser.add_argument("--verbose", action="store_true", help="Enable lifecycle logging.")
    subparsers = parser.add_subparsers(dest="command", required=True)

    parse_file = subparsers.add_parser("parse-file", help="Parse one ARM64 assembly file.")
    parse_file.add_argument("path", help="Path to a .S/.s/.asm file.")

    parse_dir = subparsers.add_parser("parse-dir", help="Parse all ARM64 assembly files in a directory.")
    parse_dir.add_argument("path", help="Path to a directory.")

    nassi_file = subparsers.add_parser(
        "nassi-file",
        help="Build a Nassi-Shneiderman HTML diagram for one ARM64 assembly file.",
    )
    nassi_file.add_argument("path", help="Path to a .S/.s/.asm file.")
    ...
    nassi_dir = subparsers.add_parser(
        "nassi-dir",
        help="Build Nassi-Shneiderman HTML diagrams for all ARM64 assembly files in a directory.",
    )
...
<html lang="en">
  ...
  <body>
    <div class="window">
      <div class="titlebar">ARM64 NSD Index</div>
      <div class="body">
